...
Odoo Manage Invoice Payment Journal Entry 
    ...
    """,
    "category": 'Accounting',
    'summary': 'multiple Invoice payments apps use to easy payment multi invoice payment | multi-vendor bill payment mass invoice payment | mass bill payment | multiple invoice payment | multiple bill payment, multiple partial payment | multi-payment vendor bill | multiple payment vendor bills, multi invoice payment',       
